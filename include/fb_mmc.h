...
#define FIP_ADD_SAVE_TO_EMMC 0x00000300
#if defined(CONFIG_R9A09G047)	/* RZ/G3E */
#define CMD_UPDATE_BOOTLOADER_BL2 \
	"fatload mmc 0:1 0x4D000000 bl2_bp_mmc-smarc-rzg3e.bin"
#define CMD_UPDATE_BOOTLOADER_FIP \
	"fatload mmc 0:1 0x4D000000 fip-smarc-rzg3e.bin"
#endif
#if defined(CONFIG_R9A08G045S)	/* RZ/G3S */
#define CMD_UPDATE_BOOTLOADER_BL2 \
	"fatload mmc 0:1 0x4D000000 bl2_bp_mmc-smarc-rzg3s.bin"
#define CMD_UPDATE_BOOTLOADER_FIP \
