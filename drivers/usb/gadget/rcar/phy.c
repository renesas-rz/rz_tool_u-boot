...
#if defined(CONFIG_R9A07G044L) || defined(CONFIG_R9A07G044C) || defined(CONFIG_R9A07G043U) || defined(CONFIG_R9A07G054L) || defined(CONFIG_ARCH_RZMPU) || defined(CONFIG_R8A774C0) || defined(CONFIG_R9A08G045S)
	is_host = false;
#endif
	if (is_host)
